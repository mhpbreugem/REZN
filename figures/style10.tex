...
\addplot[thick,color=BCred!25,smooth,tension=0.4] coordinates {(-1.768,3.500)(-1.758,3.005)(-1.751,2.510)(-1.722,2.086)(-1.591,1.670)(-1.395,1.379)(-1.167,1.135)(-0.884,0.899)(-0.601,0.709)(-0.389,0.434)(-0.110,0.177)(0.116,-0.035)(0.364,-0.318)(0.601,-0.534)(0.851,-0.813)(1.074,-1.096)(1.308,-1.337)(1.591,-1.545)(1.944,-1.689)(2.369,-1.751)(2.864,-1.752)(3.359,-1.767)(3.500,-1.768)};
\addplot[thick,color=BCblue,dashed] coordinates {(-3.5,2.50)(3.5,-4.50)};
\draw[->,thick,color=black!60] (axis cs:0.5,-0.8) -- (axis cs:1.2,-1.5);
\node[font=\scriptsize,anchor=south,color=black!70] at (axis cs:0.5,-0.7) {curvature};
\node[font=\scriptsize,color=BCblue] at (axis cs:2.0,-1.0) {CARA};
\node[font=\scriptsize,color=BCred] at (axis cs:-0.8,0.8) {CRRA};
\end{groupplot}
\end{tikzpicture}
\end{document}
