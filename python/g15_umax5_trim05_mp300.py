"""G=15, UMAX=5, trim=0.05 (keep 90%), mp300 LM. Cold start → float64 polish → mp300 NK."""
...
G = 15; UMAX = 5.0; TRIM = 0.05  # keep central 90%
...
out = f"{RESULTS_DIR}/posterior_v3_G{G}_umax5_trim05_mp300.json"
