...
H_FD = mpf("1e-100")
TARGET = mpf("1e-100")
GS = list(range(19, 26))   # 19..25 (resume from G=18 mp300 ckpt)
...
# Resume from G=18 mp300 ckpt
print(f"Loading G=18 mp300 ckpt...", flush=True)
with open(f"{RESULTS_DIR}/posterior_v3_G18_mp300_notrim.json") as f:
    state = json.load(f)
G_PREV = 18
