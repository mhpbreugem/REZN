"""G=15, UMAX=6, mp300 LM. Cold start (no learning) → float64 polish → mp300 NK."""
...
# Build grid UMAX=6
print(f"Building G={G} UMAX={UMAX} no-trim grid...", flush=True)
...
out = f"{RESULTS_DIR}/posterior_v3_G{G}_umax6_mp300.json"
with open(out, "w") as f:
    json.dump({"G": G, "UMAX": UMAX, "tau": 2.0, "gamma": 0.5, "trim": 0.0,
                "dps": 300,
