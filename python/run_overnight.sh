...
cp pchip_G11logit_forward.csv pchip_continuation_results.csv
...
cd /home/user/REZN
git add python/plot_*.png python/pchip_G11logit_forward.csv python/pchip_continuation_results.csv python/pchip_backward_results.csv python/pchip_asymmetric_results.csv 2>/dev/null || true
