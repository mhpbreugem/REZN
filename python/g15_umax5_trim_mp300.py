"""G=15, UMAX=5, trim=0.005 (keep 99%), mp300 LM. Cold start → float64 polish → mp300 NK."""
...
G = 15; UMAX = 5.0; TRIM = 0.005  # keep central 99%
...
for nk_iter in range(1, 16):
    ...
    if not accepted:
        print(f"    LM stuck, keeping mu", flush=True)
...
out = f"{RESULTS_DIR}/posterior_v3_G{G}_umax5_trim005_mp300.json"
