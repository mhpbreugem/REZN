"""G=15 PR test: γ=0.1 vs γ=20 at h=0.005, fast vectorized smooth solver.

At G=15, phi cost ≈ G^4 * G memory = 15^4 = 50,625 per iter; ~10s/iter probably.
"""
...
# Seeds: G=12 PR-test results
SEED_01 = RESULTS / f"G12_tau2_smoothfasth0.005_het0.1_0.1_0.1_g0.1_PR_prices.npz"
SEED_20 = RESULTS / f"G12_tau2_smoothfasth0.005_het20_20_20_g20_PR_prices.npz"
...
def main():
    rows = []
    for tag, gam, seed in [("g0.1_G15", (0.1, 0.1, 0.1), SEED_01),
                            ("g20_G15",  (20.0, 20.0, 20.0), SEED_20)]:
