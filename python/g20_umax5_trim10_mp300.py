"""G=20, UMAX=5, trim=0.10 (keep 80%), mp300 LM with Picard fallback.
...
G = 20; UMAX = 5.0; TRIM = 0.10  # keep central 80%
...
out = f"{RESULTS_DIR}/posterior_v3_G{G}_umax5_trim10_mp300.json"
