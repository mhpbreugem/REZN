"""γ ladder at G=12, smooth Φ (fast vectorized), h=0.005.

Confirms the γ-dependence of the PR signal at finer grid than G=6.
"""
...
SEED = RESULTS / "G6_tau2_gamma2_up_picard_0_prices.npz"  # cursor's homog γ=2
